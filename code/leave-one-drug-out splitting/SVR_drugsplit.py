...
FOLD_RESULTS_PATH = "svr_fold_results.csv"
TEST_RESULT_PATH = "svr_oof_predictions.csv"
...
for fold, (train_idx, test_idx) in enumerate(group_kfold.split(X, y, groups=groups)):
    ...
    # ======================
    def svr_objective(C, epsilon, gamma):
        model = SVR(
            C=C,
            epsilon=epsilon,
            gamma=gamma
...
# ======================
print("\nTraining final SVR model on full dataset...")
